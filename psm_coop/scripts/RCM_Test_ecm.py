...
def talker(): 
    ...
    message2.name = ['pitch_front_joint']
    ...
    for j in range(z):
        for i in range(z):    
            ...
            try:
                (trans,dummy_r) = listener.lookupTransform('/base_link' ,'/tool_link', rospy.Time(0))
                (dummy,rot) = listener.lookupTransform('/base_link' ,'/tool_link', rospy.Time(0))
    ...
    for d in range(4):
        (pitch, rot_pitch) = listener.lookupTransform('/base_link' ,'/pitch_front_link', rospy.Time(0))
